    ...
    <!-- Page Content -->
      ...
      ">
            ...
            <div class="container-fluid">
                <h1 class="mt-4">Semi-Luxury Rooms</h1>

                <ul class="list-group">
                    <li class="list-group-item">
                        Jr Standard
                        <input class="btn btn-success" type="submit" name="commit" value="Add Room" style="margin-left: 120px;">
                        <div>Book now pay later</div>
                    </li>
                    <li class="list-group-item">
                        Bed%Breakfast Flexible<input class="btn btn-success" type="submit" name="commit" value="Add Room" style="margin-left: 40px;" />
                        <div>Full payment</div>
                    </li>
                    <li class="list-group-item">
                        Package Rate Spa<input class="btn btn-success" type="submit" name="commit" value="Add Room" style="margin-left: 70px;" />
                        <div>Full payment</div>
                    </li>
                    <li class="list-group-item">
                        Sun Capture<input class="btn btn-success" type="submit" name="commit" value="Add Room" style="margin-left: 100px;" />
                        <div>Book now pay later</div>
                    </li>
                    <li class="list-group-item">
                        Family Superior<input class="btn btn-success" type="submit" name="commit" value="Add Room" style="margin-left: 80px;" />
                        <div>Book now pay later</div>
                    </li>
                </ul>
