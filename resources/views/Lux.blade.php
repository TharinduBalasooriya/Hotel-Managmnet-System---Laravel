    ...
    <!-- Page Content -->
      ...
      ">
            ...
            <div class="container-fluid">
                <h1 class="mt-4">Luxury Rooms</h1>

                <ul class="list-group">
                    <li class="list-group-item">Double Standard
                         <input class="btn btn-success" type="submit" name="commit" value="Add Room" style="margin-left: 70px;" />
                    </li>
                    <li class="list-group-item">Rack Rate Standard <input class="btn btn-success" style="margin-left: 56px;"  type="submit" name="commit" value="Add Room" />
                    <div>Book now pay later</div></li>
                    <li class="list-group-item">Package Rate Spa <input class="btn btn-success" style="margin-left: 70px;"  type="submit" name="commit" value="Add Room" />
                    <div>Full payment</div></li>
                    <li class="list-group-item">Delux Apartment <input class="btn btn-success" style="margin-left: 70px;"  type="submit" name="commit" value="Add Room" />
                        <div>Book now pay later</div></li>
                    <li class="list-group-item">Double Superior <input class="btn btn-success" style="margin-left: 70px;"  type="submit" name="commit" value="Add Room" />
                        <div>Book now pay later</div></li>
                </ul>
