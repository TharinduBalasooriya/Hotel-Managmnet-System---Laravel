...
<div class="d-flex" id="wrapper">
  ...
  <br>
      <div class="col-sm-10">
          ...
          background-image: linear-gradient(315deg, #2a2a75 0%, #009ffd 100%);">
  ...
  <div class="row customCard"  style="padding-left: 30px;padding-right: 30px; " >
        ...
        <div class="col-sm-2">
          <div class="card text-white text-center" style="background-color: #2a2a72;
          background-image: linear-gradient( 111.7deg,  rgba(165,41,185,1) 19.9%, rgba(80,177,225,1) 20%);">
            <div class="card-body">
            <i class="fas fa-swimmer fa-5x" aria-hidden="true"></i>
              <a href="/poolreg" class="text-white"><h3 >One Month Package</h3></a>
            </div>
        ...
        <div class="col-sm-2">
          <div class="card text-white text-center" style="background-color: #2a2a72;
          background-image: linear-gradient( 111.7deg, rgb(77, 0, 0) 19.9%, 	rgb(0, 128, 255) 20%);
          ">
            <div class="card-body">
            <i class="fas fa-swimmer fa-5x" aria-hidden="true"></i>
              <a href="/poolreg" class="text-white" ><h3 >Three Month Package</h3></a>
            </div>
        ...
        <div class="col-sm-2">
          ...
          background-image: linear-gradient( 111.7deg,  rgba(165,41,185,1) 19.9%, rgba(80,177,225,1) 20%);">
            <div class="card-body">
            <i class="fas fa-swimmer fa-5x" aria-hidden="true"></i>    
            <a href="/poolreg" class="text-white"><h3 >Six Month Package</h3></a>
            </div>
        ...
        <div class="col-sm-2">
          ...
          background-image: linear-gradient( 111.7deg, rgb(77, 0, 0) 19.9%, 	rgb(0, 128, 255) 20%);">
            <div class="card-body">
            <i class="fas fa-swimmer fa-5x" aria-hidden="true"></i>
              <a href="/poolreg" class="text-white"><h3 >One Year Package</h3></a>
            </div>
...
<br>
  ...
  <div class="row customCard"  style="padding-left: 30px;padding-right: 30px; " >
        ...
        <div class="col-sm-2">
          <div class="card text-white text-center" style="background-color: #2a2a72;
          background-image: linear-gradient(315deg, #ff00ff 0%, 	#ff0080 60%);">
            <div class="card-body">
            
              <a href="/poolprof" class="text-white"><h3>Pool Member List</h3></a>
            </div>
        ...
        <div class="col-sm-2">
          <div class="card text-white text-center" style="background-color: #2a2a72;
          background-image: linear-gradient(315deg, #ff00ff 0%, 	#808080 60%);;
          ">
            <div class="card-body">
            
              <a href="/poolprof" class="text-white" ><h3>Update Members</h3></a>
            </div>
        ...
        <div class="col-sm-2">
          ...
          background-image: linear-gradient(315deg, #ff00ff 0%, 	#ff0080 60%);">
            ...
            <a href="/get-all-member" class="text-white"><h3>Member Report</h3></a>
            </div>
        ...
        <div class="col-sm-2">
          ...
          background-image: linear-gradient(315deg, #ff00ff 0%, 	#808080 60%);">
            <div class="card-body">
              ...
              <a href="/download-pdf" class="text-white"><h3>Download Report</h3></a>
            </div>
